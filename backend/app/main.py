"""
================================================================================
Marketplace ERP - FastAPI Main Application
================================================================================
Version: 1.13.0
...
async def lifespan(app: FastAPI):
    ...
    # STARTUP
    # ========================================================================
    logger.info("🚀 Starting Marketplace ERP API...")
    ...
    # SHUTDOWN
    # ========================================================================
    logger.info("👋 Shutting down Marketplace ERP API...")
...
# Import routers
from app.routes import auth, admin, dashboard, tickets, development, docs, telegram, security, webhooks, email, api_keys, websocket, b2c_ops, product, zoho_item, zoho_vendor, zoho_customer
