"""
================================================================================
Zoho Customer Management Service
================================================================================
Version: 1.0.0
Created: 2025-12-02

Service for managing Zoho customers, sync operations, and CRUD
================================================================================
"""
...
from app.schemas.zoho_customer import ZohoCustomerCreate, ZohoCustomerUpdate
...
async def get_items(
    ...
    try:
        ...
        # Get total count
        count_query = f"SELECT COUNT(*) as total FROM zoho_customers WHERE {where_clause}"
        ...
        raise HTTPException(
            ...
            detail="Failed to fetch Zoho customers"
        )
