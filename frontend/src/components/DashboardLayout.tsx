...
export default function DashboardLayout() {
    ...
    useEffect(() => {
        ...
        fetchModules();
    }, []); // removed enqueueSnackbar dependency as it's stable
    ...
    const getSubModules = (parentModuleId: string | number) => {
    ...
    const getSubModuleRoute = (parentModuleKey: string, subModuleKey: string) => {
        // Admin sub-modules
        ...
        // B2C Ops sub-modules
        const b2cOpsRoutes: Record<string, string> = {
        ...
        const b2cManagementRoutes: Record<string, string> = {
            ...
            b2c_order_list: '/b2c-ops/b2c-order-list',
        ...
        const databaseManagementRoutes: Record<string, string> = {
        ...
        const inwardRoutes: Record<string, string> = {
        ...
        const outwardRoutes: Record<string, string> = {
        ...
        const reportingRoutes: Record<string, string> = {
        ...
        // Tickets sub-modules
        const ticketsRoutes: Record<string, string> = {
