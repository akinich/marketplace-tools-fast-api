...
function WooCustomerMaster() {
    ...
    const handleCustomerUpdate = async (updatedRow: WooCustomer, originalRow: WooCustomer) => {
        try {
            const changes: Partial<WooCustomer> = {};

            // Find changed fields
            (Object.keys(updatedRow) as Array<keyof WooCustomer>).forEach((key) => {
                // @ts-ignore
