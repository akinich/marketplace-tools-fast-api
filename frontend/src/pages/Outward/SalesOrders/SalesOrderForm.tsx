    ...
    useEffect(() => {
        const loadCommonData = async () => {
            try {
                ...
                // Adjust depending on actual API response structure (items vs customers)
                ...
                console.error('Failed to load customers/items:', error);
                enqueueSnackbar('Failed to load customers or items', { variant: 'error' });
            }
        };
